...
不从理论开始，直接展示一个实际成果：
- hxa-teams 项目从立项到交付的全过程回放
- 涉及：调研、定位文档、repo 搭建、PR review、发布
- 关键数据：3 个 Agent 参与，7 个 PR，从零到 MVP 用了 X 天
...
- 或者："查一下我们 hxa-teams repo 的最新状态，列出所有已完成的 PR 和当前 open 的 issue"
