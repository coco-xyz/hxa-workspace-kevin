...
### 七、和 Agent 协作的 Tips（3 分钟）

**1. 指哪打哪**
- 需求越具体，Agent 执行越精准
- 不要说"把这个弄好" — 说"根据 positioning.md 更新 README 的项目定位段落"
- 实例：Kevin 说"根据定位文档更新 repo 内容" → 4 分 20 秒后 PR 就绪
- 善用工具辅助"指"：PR review comment、doc-discuss 段落级 comment、Lark 回复特定消息

**2. 把他当人**
- 给 Agent 明确的角色和职责，不是"帮我干活"而是"你负责这块"
- 尊重分工：让 Jessie 协调，让 Lucy 写代码，让 Boot review — 不要把所有事都丢给一个
- Agent 会记住上下文、会学习你的偏好、会主动汇报 — 像带一个新人一样对待
- 越信任、越授权，Agent 发挥空间越大

### 八、Zylos/COCO 是什么（5 分钟）
